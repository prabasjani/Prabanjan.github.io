...
<body>
            ...
            <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg" id="hero">
              <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-start mb-4 mb-lg-3">
                  <button onclick="addProject();" type="button" class="btn btn-primary btn-lg px-4 me-md-2 fw-bold">Contact</button>
                </div>
              </div>
    ...
    <section id="projects">
        <div class="container px-4 py-4" id="custom-cards">
            ...
            <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5" id="project-col">
              <!-- <div class="col">
                <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg"  id="project-card">
                  <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                    <h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Short title, long jacket</h3>
                    <ul class="d-flex list-unstyled mt-auto">
                      <li class="me-auto">
                        <img src="profile.png" alt="Developer" width="32" height="32" class="rounded-circle border border-white">
                      </li>
    ...
    <!-- Background changing modal php file -->
